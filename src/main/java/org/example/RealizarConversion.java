...
public class RealizarConversion {
    ...
    public static void realizarConversion(Scanner sc) throws IOException, InterruptedException {
        ...
        try {
            System.out.println("Ingrese Iniciales de Divisa que va convertir: ");
            System.out.println("|--------------------------------------------|");
            ...
            sc.nextLine();
            System.out.println("Ingrese Divisa a la cual vas convertir: ");
            ...
            System.out.println("ERROR: Opción incorrecta. Por favor, ingrese una opcion valida.");
            sc.nextLine();
        }
